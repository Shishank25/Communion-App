    ...
    >
        ...
        <div className='flex flex-col lg:flex-row justify-between relative animate-fade-in'>
            <div className={`mt-30 mx-6 flex flex-col transition-all duration-400 ${isSigning ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <p className='my-4 text-center sm:w-150 text-lg italic font-inter'>
                    Connect with like-minded people, explore events, and engage with your community in meaningful ways.
                </p>
                ...
                <div className='flex flex-col justify-center items-center mt-10'>
                    ...
                    <button 
                        className='cta-button text-2xl rounded-2xl font-medium bg-[#e48f7a] text-[#fff5f0] 
                        mt-4 px-2 py-2 cursor-pointer w-60 self-center transition-all hover:scale-110 hover:shadow-xl'
            ...
            {/* Home Screen Movie */}
            <div 
                className={`h-auto sm:mx-auto mt-5 xl:mr-30 transition-all ease-out duration-1500 
                ${isSigning ? 'lg:-translate-x-140' : 'lg:translate-x-0'}`}
            >
