...
const Navbar = () => {
  ...
  return (
        <div className={`backdrop-blur font-medium flex w-full shadow-lg justify-between h-12 px-5 py-3 transition-all duration-300 border-b border-neutral-600 fixed absolute z-5 ${navbarShow ? 'top-0' : '-top-12'}`}>
